...
function MobileNavigation() {
  const { isAuthenticated, isAuthStatusLoading } = useAuth()
  return (
    <Popover>
      <Popover.Button
      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            {isAuthenticated && !isAuthStatusLoading ? (
              <MobileNavLink href="/search">Dashboard</MobileNavLink>
            ) : null}
          </Popover.Panel>
        </Transition.Child>
      </Transition.Root>
        ...
        <nav className="relative z-50 flex justify-between">
          ...
          <div className="flex items-center gap-x-5 md:gap-x-8">
            <div className="hidden items-center justify-center gap-x-3 md:flex">
              {isAuthenticated && !isAuthStatusLoading ? (
                <Button href="/search">Dashboard</Button>
              ) : null}
